...
log_dir_pretrained_GS=/home/fanbin/fan/UniVR/UniVR_SoftSplat/deep_unroll_weights/Pretrained/
log_dir=/home/fanbin/fan/UniVR/UniVR_SoftSplat/deep_unroll_weights/
#
cd deep_unroll_net
